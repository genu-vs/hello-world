...
z[0]=((-0.02366)*an[12])+((0.17116)*an[1])-((0.05705)*an[2])-((1.07430));
z[1]=((0.10235)*an[13])+((0.08305)*an[14])-((0.16216)*an[11])-((1.38154));
z[2]=((0.11691)*an[14])-((0.08829)*an[10])-((0.02799)*an[8])-((0.85295));
z[3]=((0.17654)*an[14])+((0.12037)*an[11])-((0.08718)*an[9])-((0.13941)*an[4])+((0.14995)*an[8])-(0.80406);
...
z[7]=((0.13997)*an[14])+((0.21743)*an[1])-((0.08396)*an[4])-((0.42197));
z[8]=((-0.12965)*an[2])-((0.23442)*an[7])+((1.55251));
