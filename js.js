...
res[i]=zzz;
	...
	{var z=[0.00000,0.00000,0.00000,0.00000,0.00000,0.00000,0.00000,0.00000,0.00000];
z[0]=((-0.02366)*an[12])+((0.17116)*an[1])-((0.05705)*an[4])-((1.07430));
z[1]=((0.10235)*an[14])+((0.08305)*an[11])-((0.16216)*an[4])-((1.38154));
z[2]=((0.11691)*an[14])-((0.08829)*an[10])-((0.02799)*an[8])-((0.85295));
z[3]=((0.17654)*an[14])+((0.12037)*an[11])-((0.13941)*an[4])+((0.14995)*an[8])-(0.80406);
z[4]=((0.15889)*an[14])+((0.28112)*an[11])-((0.16080)*an[4])-((0.70052));
z[5]=((0.14571)*an[14])-((0.14720)*an[11])+((0.09738)*an[9])+((0.09738)*an[4])-((0.68008));
z[6]=((0.17899)*an[1])+((0.11903)*an[4])+((0.11903)*an[8])+((0.10237)*an[7])-((1.34381));
z[7]=((0.13997)*an[12])+((0.21743)*an[1])-((0.08396)*an[4])-((0.42197));
z[8]=((-0.12965)*an[2])-((0.23442)*an[5])-((0.23442)*an[6])+((1.55251));
